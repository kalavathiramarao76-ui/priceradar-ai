    ...
    >
      <div className="flex items-start gap-3">
        ...
        <button
          ...
          className="shrink-0 text-white/40 hover:text-white/80 transition-colors text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-500 rounded"
        >
          &#x2715;
        </button>
      </div>
